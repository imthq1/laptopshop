...
<head>
    ...
    <meta name="description" content="Login to your Laptopshop account" />
                            ...
                            <div class="card-body">
                                <form method="post" action="/login">
                                    <c:if test="${param.error !=null}">
                                        <dif class="my-2" style="color: red">Invalid email or password</dif>
                                    </c:if>
                                    ...
                                    <%-- Uncomment this block if you want to include "Remember Me" functionality
